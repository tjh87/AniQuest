export const FIELD_SOURCES = {
  ...
  guide: { name: "NParks · Garden Bird Watch species list", url: "https://www.nparks.gov.sg/nature/community-in-nature/garden-bird-watch" },
...
export function FieldResources() {
  return <section className="aq-panel aq-field-resources" aria-labelledby="field-practice-heading">
    ...
    <div className="aq-info-grid">
      ...
      <article><h3>Use a local reference</h3><p>Start with the NParks Garden Bird Watch list of common native and migratory birds. Compare several traits before naming a bird.</p><p>The survey list is not a full field guide or a conservation assessment. Check each AniQuest profile for current status sources.</p><FieldSource source="guide" /></article>
    </div>
    ...
    <small>Sources checked 13 September 2026. Read the source for current rules and programme dates.</small>
  </section>;
}
