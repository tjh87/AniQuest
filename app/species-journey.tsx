...
export function SpeciesJourney({ speciesId, records, onAnswer, onAction, onProfile, onChoose }: {
  ...
  const [sessionId, setSessionId] = useState(() => attempts.at(-1)?.sessionId || createClientId());
